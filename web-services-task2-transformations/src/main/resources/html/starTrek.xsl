                    ...
                    <xsl:for-each select="blog/posts/post">
                        <div id="modal{@id}" class="modal hide">
                            <div class="modal_content">
                                <img class="star_trek_image" src="{image}" alt="post_image" />
                        ...
                        <div class="star_trek">
                            <img class="star_trek_image" src="{image}" alt="post_image" />
                            <div class="star_trek_content">
                                <a class="star_trek_content_category">
                                    <xsl:value-of select="category" />
                                </a>
                                <h2 class="post_card_content_title">
                                    <xsl:value-of select="title" />
                                </h2>
                                <p class="star_trek_content_summary">
                                    <xsl:value-of select="summary" />
                                </p>
                                <div class="star_trek_content_button" data-id="{@id}">
                                    <a class="button primary">CONTINUE READING</a>
                                </div>
                                <hr />
                                <div class="star_trek_content_bottom">
                                    <div>
                                        By
